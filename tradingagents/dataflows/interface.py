...
from .y_finance import get_YFin_data_online, get_stock_stats_indicators_window, get_all_stock_indicators, get_fundamentals as get_yfinance_fundamentals, get_balance_sheet as get_yfinance_balance_sheet, get_cashflow as get_yfinance_cashflow, get_income_statement as get_yfinance_income_statement, get_insider_transactions as get_yfinance_insider_transactions
...
VENDOR_METHODS = {
    ...
    "get_all_indicators": {
        "yfinance": get_all_stock_indicators,
        "local": get_all_stock_indicators,
    },
    # fundamental_data
    "get_fundamentals": {
